        ...
        <article className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-10 shadow-xs space-y-8">
            ...
            <div className="overflow-x-auto border border-slate-200 rounded-xl">
              <table className="w-full text-left text-xs border-collapse">
                ...
                <tbody className="divide-y divide-slate-100 text-slate-600">
                  <tr>
                    <td className="p-3 font-mono font-semibold text-slate-900">sb-access-token / sb-refresh-token</td>
                    ...
                    <td className="p-3 text-slate-500">
                      Standard first-party authentication and session management tokens required to identify and authorize merchant database queries.
                    </td>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-xs text-amber-900 leading-relaxed">
              <strong>Crucial Operational Disclaimer:</strong> Because our first-party session management cookies (<code className="bg-amber-100 px-1 py-0.5 rounded font-mono text-[11px]">sb-access-token / sb-refresh-token</code>) are strictly essential for database query authorizations, disabling or blocking them will block the application from loading and prevent you from accessing your merchant dashboard.
            </div>
          </section>
