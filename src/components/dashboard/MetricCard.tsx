...
import { LucideIcon, TrendingUp, TrendingDown, ArrowUpRight, ArrowDownRight, Info } from 'lucide-react';
...
export function MetricCard({
  ...
  return (
    ...
    >
      ...
      {/* Card Footer: Count badge & Trend indicator */}
