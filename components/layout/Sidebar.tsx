...
const PRIMARY_NAV: NavItemDef[] = [
  ...
  { href: '/dashboard/whatsapp', route: 'whatsapp_ai', label: 'WhatsApp Assistant', icon: BotMessageSquare, badge: 'AI' },
  ...
  { href: '/dashboard/receivables', route: 'receivables', label: 'Receivables', icon: ClockAlert },
