...
> = {
  ...
  settings: {
    ...
    description: 'Manage GST profiles, WhatsApp Business API webhooks, and Supabase RLS team roles.',
    icon: Settings,
  ...
  return (
    <div className="p-6 sm:p-8 max-w-4xl mx-auto" id={`module-placeholder-${route}`}>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-xs">
        ...
        <div className="mt-8 p-4 rounded-xl bg-emerald-50/50 border border-emerald-200 text-xs text-emerald-900 flex items-center justify-between">
          <span>The main Whatsbill Web Dashboard module is fully functional and connected.</span>
          <button
            onClick={onBackToDashboard}
            className="px-3.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition"
          >
            Go to Dashboard
          </button>
        </div>
