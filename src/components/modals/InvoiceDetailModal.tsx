...
import { X, ReceiptText, Calendar, Building, Phone, Mail, CheckCircle2, Clock, AlertCircle, CreditCard, Send } from 'lucide-react';
import { InvoiceWithDetails } from '../../types/database';
import { formatDate, formatINR, getInvoiceStatusConfig } from '../../utils/formatters';
        ...
        <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Tax Invoice • Whatsbill Core Ledger</p>
            </div>
          </div>
