...
import { formatINR, getPriorityConfig } from '../../utils/formatters';
...
export function CollectionQueue({
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-4 sm:p-5 shadow-2xs flex flex-col h-full" id="ai-collection-queue-section">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-3 border-b border-slate-100">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Prioritized by aging debt, credit limits, and collection velocity
          </p>
        </div>
